  ...
  return (
    <main className="bg-[#F9F9F5]">
      ...
      <section className="section-y-lg container-pf text-center">
        <p className="label text-[#302B29]/50 mb-7">Boston Area Full Service Wedding Florist</p>
        <p className="font-times text-[#302B29] leading-[1.5] max-w-2xl mx-auto" style={{ fontSize: "clamp(24px, 3vw, 38px)" }}>
      ...
      <section className="grid md:grid-cols-2">
        <div className="bg-[#373F24] flex flex-col justify-center px-8 md:px-20 py-24 md:py-32 order-2 md:order-1">
      ...
      <section className="section-y-lg container-pf">
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-8 md:gap-10">
          {[
            ...
            <Reveal key={o.t} delay={i * 110} className="bg-[#F0EAE0] p-12 text-center">
      ...
      {/* Ready CTA */}
      <section className="section-y-lg px-6 text-center bg-[#F9F9F5]">
